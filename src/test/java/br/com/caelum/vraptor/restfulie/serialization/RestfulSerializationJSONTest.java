...
public class RestfulSerializationJSONTest {
	...
	class CustomType implements HypermediaController{
	...
	public void shouldReturnAnXStreamInstanceWithSupportToLinkConvertersBasedOnReflection() {
		RestfulSerializationJSON serialization = new RestfulSerializationJSON();
	...
	public void shouldAllowCustomXStreamRetrieval() {
		...
		RestfulSerialization serialization = new RestfulSerialization() {
			@Override
