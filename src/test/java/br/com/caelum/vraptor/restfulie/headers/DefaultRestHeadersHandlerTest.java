...
public class DefaultRestHeadersHandlerTest {
	...
	@Test
	public void whenControllerIsSimpleDoNothing() {
		handler.handle(mock(HypermediaController.class));
	}

	class CacheableOrder implements Cacheable, HypermediaController{
	...
	class CacheableOrderEntity implements RestfulEntity, HypermediaController {
