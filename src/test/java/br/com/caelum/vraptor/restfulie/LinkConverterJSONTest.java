...
/**
 * Ensure that JSON serialization, of Restful resources, contains resources
 * links. And not restful resources remains untouched.
 */
public class LinkConverterJSONTest {
	...
	public void setup() {
		...
		when(config.getApplicationPath())
				.thenReturn("http://www.caelum.com.br");

		xstream = new XStream(new JsonHierarchicalStreamDriver());
		ReflectionConverter base = new ReflectionConverter(xstream.getMapper(),
